...
{
    [UsedImplicitly]
    public class LineColorInitializer : LoadingExtensionBase, IUserMod
    {
        public string Name => "Line Color Initializer";
        public string Description => "Random line colors for your transport lines";
